...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  // populate current node's neighbor vectors
  ...
  for(auto neighbor : neighbors_local){
    ...
    // update g ( cost to reach the neighbor)
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
	...
	while(current_node->parent != nullptr && current_node->parent != nullptr){
...
void RoutePlanner::AStarSearch() {
    ...
    // TODO: Implement your solution here.
  	...
  	// Expand the nodes until the goal is reached
